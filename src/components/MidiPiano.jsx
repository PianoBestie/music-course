...
const MidiPiano = () => {
  ...
  const highlightKey = (noteName) => {
    ...
    const key = pianoRef.current.querySelector(`.key[data-note="${noteName}"]`);
    if (key) {
  ...
  return (
    <div className="piano-container bg-gradient-to-tr from-[#6d306d] to-[#3B444E] text-white">
      <h2 className="text-xl font-semibold my-3">MIDI Piano Player</h2>
<div className="flex gap-5 items-center">
      ...
      <div><h3 className="text-xl font-semibold my-2">{fileName?fileName:'mid file not uploaded yet'}</h3></div>
      </div>

      <div className="flex piano " ref={pianoRef}>
